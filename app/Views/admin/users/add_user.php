                                ...
                                <form novalidate>
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="mb-1">
                                                <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                    <input required type="text" class="form-control" value="<?= set_value('firstname') ?>" name="firstname" placeholder="First Name">
                                            ...
                                            <div class="mb-1">
                                                <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                    <input type="text" class="form-control" value="<?= set_value('lastname') ?>" name="lastname" placeholder="Last Name">
                                                    <div class="form-control-position">
                                                        <i class="bx bx-user"></i>
                                                    </div>
                                                </fieldset>
                                            ...
                                            <div class="mb-1">
                                                <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                    <input type="text" class="form-control" value="<?= set_value('adresse') ?>" name="adresse" placeholder="Adress">
                                                    <div class="form-control-position">
                                                        <i class="bx bx-map"></i>
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control" id="inputGroupSelect01" name="brancheId">
                                                            ...
                                                            <?php foreach ($branches as $branch) : ?>
                                                                <option <?php if (set_value('brancheId') == $branch['id']) : ?>selected<?php endif; ?> value="<?= $branch['id']; ?>"><?= $branch['name']; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </fieldset>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control" id="roleSelect" name="role" onchange="onRoleChange()">
                                                            ...
                                                            <?php foreach ($roles as $role) : ?>
                                                                <option <?php if (set_value('role') == $role['code']) : ?>selected<?php endif; ?> value="<?= $role['code']; ?>"><?= $role['title']; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </fieldset>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-8 form-group">
                                                                    <div class="position-relative has-icon-left">
                                                                        <input type="email" id="email-icon" class="form-control" value="<?= set_value('email') ?>" name="email" placeholder="Email">
                                                                        <div class="form-control-position">
                                                                ...
                                                                <div class="col-md-8 form-group">
                                                                    <div class="position-relative has-icon-left">
                                                                        <input type="password" class="form-control" value="<?= set_value('cpassword') ?>" name="cpassword" placeholder="Confirm Password">
                                                                        <div class="form-control-position">
                                                                            <i class="bx bx-lock"></i>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="mb-1">
                                                <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                    <input type="text" class="form-control" value="<?= set_value('cin') ?>" name="cin" placeholder="CIN">
                                                    <div class="form-control-position">
                                            ...
                                            <div class="mb-1">
                                                <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                    <input type="text" class="form-control" value="<?= set_value('mobile_no') ?>" name="mobile_no" placeholder="Mobile Number">
                                                    <div class="form-control-position">
                                            ...
                                            <div class="mb-1">
                                                <fieldset class="form-group position-relative has-icon-left">
                                                    <input type="text" class="form-control pickadate" value="<?= set_value('dateInscription') ?>" name="dateInscription" placeholder="Subscription Date">
                                                    <div class="form-control-position">
                                                ...
                                                <fieldset class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control" name="gender" id="inputGroupSelect01">
                                                            <option value="">Choose...</option>
                                                            <option <?php if (set_value('gender') == "Feminin") : ?>selected<?php endif; ?> value="Feminin">Feminin</option>
                                                            <option <?php if (set_value('gender') == "Masculin") : ?>selected<?php endif; ?> value="Masculin">Masculin</option>
                                                        </select>
                                                    </div>
                                                </fieldset>
                                            </div>
                                                ...
                                                <fieldset class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control" name="language" id="inputGroupSelect01">
                                                            <option value="">Choose...</option>
                                                            <option <?php if (set_value('language') == "EN") : ?>selected<?php endif; ?> value="EN">English</option>
                                                            <option <?php if (set_value('language') == "FR") : ?>selected<?php endif; ?> value="FR">French</option>
                                                        </select>
                                                    </div>
                                                </fieldset>
                                            </div>
...
<script>
    ...
    <?php if (set_value('role') == "ADM" || set_value('role') == "RSP") { ?>
        document.getElementById('loginInfoSection').style.display = "block";
    <?php } else { ?>
        document.getElementById('loginInfoSection').style.display = "none";
    <?php } ?>
